...
import { BlogFKData } from './blog-fk.data';
...
describe('BlogFKComponent', () => {
  ...
  beforeEach(async(() => {
    mockBlogViewService.getGrid.and.returnValue(Observable.of(BlogFKData));
    TestBed.configureTestingModule({
      ...
      providers: [
        { provide: BlogFKService, useValue: mockBlogViewService },
  ...
  it('should open Add Blog modal', async(() => {
    ...
    expect(modal.nativeElement.textContent).toEqual('Add Blog FK');
  }));

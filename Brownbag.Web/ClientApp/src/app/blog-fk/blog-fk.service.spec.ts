...
describe('Service: Blog FK', () => {
  ...
  it('should match endpoint for Blog FK getGrid', inject([BlogFKService, GridRestCallsBaseService], (service: BlogFKService, base: GridRestCallsBaseService) => {
  ...
  // tslint:disable-next-line:max-line-length
  it('should match endpoint for Blog FK getGridItemDetails', inject([BlogFKService, GridRestCallsBaseService], (service: BlogFKService, base: GridRestCallsBaseService) => {
    expect(service).toBeTruthy();
    const itemId = '10';
  ...
  // tslint:disable-next-line:max-line-length
  it('should match endpoint for Blog FK updateGridItem', inject([BlogFKService, GridRestCallsBaseService], (service: BlogFKService, base: GridRestCallsBaseService) => {
    expect(service).toBeTruthy();
    const fakeEntity = {};
